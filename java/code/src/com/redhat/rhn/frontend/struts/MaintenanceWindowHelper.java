...
public class MaintenanceWindowHelper {
    ...
    /**
     * Given the systems and action type, populate the request object with available maintenance windows.
     *
     * @param request the Struts request
     * @param actionType the {@link ActionType}
     * @param systemIds list of {@link Server}s
     */
    // todo actionType maybe optional?
    public static void prepopulateMaintenanceWindows(HttpServletRequest request, ActionType actionType,
            Set<Long> systemIds) {
        try {
